...
const lugares = [
  ...
  imagen: Guanajuato },// Sustituir con la URL de la imagen de Guanajuato

{
  ...
  imagen: Guadalajara, // Sustituir con la URL de la imagen de Guadalajara
},
{
  nombre: "Cancún",
  descripcion:
  ...
  imagen: Cancun, // Sustituir con la URL de la imagen de Cancún
},
{
  nombre: "Madrid",
  descripcion:
  ...
  imagen: Madrid, // Sustituir con la URL de la imagen de Madrid
},
{
  nombre: "Edimburgo",
  descripcion:
  ...
  imagen: Edimburgo, // Sustituir con la URL de la imagen de Madrid
},
{
  nombre: "Sydney",
  descripcion:
  ...
  imagen: Sydney, // Sustituir con la URL de la imagen de Madrid
}

// Agrega otros lugares si es necesario
];
...
function DetalleLugar() {
  ...
  const lugar = lugares.find((lugar) => lugar.nombre.toLowerCase() === titulo.toLowerCase());
